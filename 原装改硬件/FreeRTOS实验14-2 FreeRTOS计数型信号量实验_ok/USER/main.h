...
TaskHandle_t SemapGive_task_Handler;
TaskHandle_t SemapTake_task_Handler;
...
extern void SemapGive_task(void *pvParameters);
extern void SemapTake_task(void *pvParameters);
