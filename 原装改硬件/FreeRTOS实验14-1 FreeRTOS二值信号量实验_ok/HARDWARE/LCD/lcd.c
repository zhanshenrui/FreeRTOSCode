...
{ 										  
	...
	//PORTD复用推挽输出 	//PD0,PD1,PD8,PD9,PD10,PD14,PD15 (FSMC_D2,D3,D13,D14,D15,D0,D1)
												//PD4(NOE),PD5(NWE)
	GPIOD->CRH&=0X00FFF000;
	GPIOD->CRH|=0XBB000BBB; 
	GPIOD->CRL&=0XFF00FF00;
	GPIOD->CRL|=0X00BB00BB;   	 
	//PORTE复用推挽输出 	//PE7-E15(FSMC_D4-D12)
	GPIOE->CRH&=0X00000000;
	GPIOE->CRH|=0XBBBBBBBB; 
	GPIOE->CRL&=0X0FFFFFFF;
	GPIOE->CRL|=0XB0000000;    	    	 											 
	//PORTG12复用推挽输出 	//PG0(FSMC_RS),PG12(FSMC_NE4)    	 											 
...
//显示字符串
//x,y:起点坐标
//width,height:区域大小，字体底部背景框的大小，width为宽度，一个字母的width为8，height一般与字体一样大  
//size:字体大小，只能取8，16，24，一般用16
//*p:字符串起始地址
//一个英文字母占的宽度是8，一个汉字占16
